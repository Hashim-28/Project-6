    ...
    return (
        <div className='w-[106.2%] bg-[#1E1E2E] -ml-10 p-[61px] -mb-10  -mt-10'>
            <div className="material-return-form-container p-6 bg-[#27303D] shadow-md rounded-md">
                <h1 className="text-xl font-semibold mb-8">Pending Inward Gate Pass</h1>
                <form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div className="flex justify-end items-center">
                       <Link href={'/pending-approval3'}> <Button type="button" className="mr-2">
                            <Trash2 className="icon mr-2 h-4 w-4" />Clear
                        </Button></Link>
                        
                       <Link href={'/sbfa3'}> <Button type="submit" className="mr-2">
