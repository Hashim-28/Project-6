...
const demo = [
  {
    ...
    ApprovedBy: "", 
    Time: "", 
    Show: <Link href={'/pending-purchase-order-form'}><SearchIcon /></Link>,
  },
  {
    PoNo: "10002",
    PODate: "2024-09-13", 
...
const PendingPO = () => {
  const [PoNo, setPoNo] = useState<Checked>(false);
  ...
  return (
    ...
    <div className="material-account w-[106.2%] bg-[#1E1E2E] -ml-10 p-[61px] -mb-10 -mt-10 h-[100vh]">
      ...
      <div className="p-6 bg-[#27303D] shadow-md rounded-md mt-10 ">
       <h1 className="mb-4 text-xl text-white">Purchase Order</h1>
            ...
            <div className="grid grid-cols-3 w-[400px] mb-10">
              <DropdownMenu>
                ...
                <DropdownMenuContent   className="w-56 text-white bg-[#1E1E2E] border-none shadow-[0px_0px_10px_5px_rgba(0,0,0,0.5)]">
                  ...
                  <DropdownMenuCheckboxItem checked={PoNo} onCheckedChange={setPoNo} className="focus:bg-[#3D9C75]">PO No</DropdownMenuCheckboxItem>
        <DropdownMenuCheckboxItem checked={PODate} onCheckedChange={setPODate} className="focus:bg-[#3D9C75]">PO Date</DropdownMenuCheckboxItem>
