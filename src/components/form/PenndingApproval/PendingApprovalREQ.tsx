...
const demo = [
  {
    ...
    Show: <Link href={'/Pending-requsition-form'}><SearchIcon /></Link>,
  },
  {
    ReqNo: "10002",
    ReqDate: "2024-09-13",
...
const PendingRequest = () => {
  ...
  const allColumns = [
    { key: 'ReqNo', name: 'Req No' },
    { key: 'ReqDate', name: 'Req Date' },
  ...
  const areAnyColumnsSelected = [
    ReqNo, ReqDate, ApprovedBy, Time, Show
].some(Boolean);

const selectedColumns = areAnyColumnsSelected ? allColumns.filter((column) => {
    switch (column.key) {
      case 'ReqNo': return ReqNo;
      case 'ReqDate': return ReqDate;
...
//   window.location.href = '/second-page'; // or use React Router
// };
  ...
  return (
    ...
    <div className="material-account w-[106.2%] bg-[#1E1E2E] -ml-10 p-[61px] -mb-10 -mt-10 h-[100vh]">
      ...
      <div className="p-6 bg-[#27303D] shadow-md rounded-md mt-10 ">
       <h1 className="mb-4 text-xl text-white">Pending Requistions</h1>
            ...
            <div className="grid grid-cols-3 w-[400px] mb-10">
              <DropdownMenu>
                ...
                <DropdownMenuContent   className="w-56 text-white bg-[#1E1E2E] border-none shadow-[0px_0px_10px_5px_rgba(0,0,0,0.5)] ">
                  ...
                  <DropdownMenuCheckboxItem checked={ReqNo} onCheckedChange={setReqNo} className="focus:bg-[#3D9C75]">Req No</DropdownMenuCheckboxItem>
        <DropdownMenuCheckboxItem checked={ReqDate} onCheckedChange={setReqDate}  className="focus:bg-[#3D9C75]">Req Date</DropdownMenuCheckboxItem>
        <DropdownMenuCheckboxItem checked={ApprovedBy} onCheckedChange={setApprovedBy}  className="focus:bg-[#3D9C75]">Approved By</  DropdownMenuCheckboxItem>
        <DropdownMenuCheckboxItem checked={Time} onCheckedChange={setTime}  className="focus:bg-[#3D9C75]">Time</DropdownMenuCheckboxItem>
        <DropdownMenuCheckboxItem checked={Show} onCheckedChange={setShow}  className="focus:bg-[#3D9C75]">Show</DropdownMenuCheckboxItem>
