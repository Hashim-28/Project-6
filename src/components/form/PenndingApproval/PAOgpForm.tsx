...
const demoData = [
        { itemCode: 'A100', itemName: 'Item 1', uom: 'kg', qty: 150, ogpQty: 120 ,balance:2000,remarks:"Good"},
    ];
...
const PAOgpForm = () => {
    ...
    //             setValue('ogpNo', data.ogpNo);
    //             setValue('ogpDate', data.ogpDate);
    ...
    return (
        <div className='w-[106.2%] bg-[#1E1E2E] -ml-10 p-[61px] -mb-10  -mt-10'>
            <div className="material-return-form-container p-6 bg-[#27303D] shadow-md rounded-md">
                <h1 className="text-xl font-semibold mb-8">Pending Outward Gate Pass</h1>
                <form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-2 gap-4 mb-4">
                        <div>
                            <label className="flex text-sm font-medium">
                                <ClipboardList className='pr-1' />OGP No
                            </label>
                            <Input
                                type="number"
                                {...register('ogpNo')}
                        ...
                        <div>
                            <label className="flex text-sm font-medium">
                                <CalendarRange className='pr-1' />OGP Date
                            </label>
                            <Input
                                type="date"
                                {...register('ogpDate')}
                    ...
                    <div className="flex justify-end items-center">
                      <Link href={'/pending-approval5'}>  <Button type="button" className="mr-2">
                            <Trash2 className="icon mr-2 h-4 w-4" />Clear
                        </Button></Link>
                      <Link href={'/sbfa5'}> <Button type="submit" className="mr-2">
                        <Rows4 className="icon mr-2 h-4 w-4"/>
                            SBFA
                        </Button></Link> 
                      <Link href={'/approve5'}>  <Button type="submit">
