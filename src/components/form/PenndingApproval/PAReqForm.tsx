...
import { Trash2, PlusCircle, Edit, CalendarRange, ClipboardList, MessageCircleMore, CircleCheck, Rows4, CircleX } from 'lucide-react';
    ...
    return (
        <div className='w-[106.2%] bg-[#1E1E2E] -ml-10 p-[61px] -mb-10 -mt-10'>
            <div className="material-return-form-container p-6 bg-[#27303D] shadow-md rounded-md">
                <h1 className="text-xl font-semibold mb-8">Pending Requisition</h1>
                <form onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <div className="flex justify-end items-center">
                        <Link href={'/pending-approval1'}><Button type="button" className="mr-2">
                            <CircleX className="icon mr-2 h-4 w-4" />Cancel
                        </Button></Link>
                       <Link href={'/sbfa1'}> <Button type="submit" className="mr-2">
