...
const demo = [
  {
    ...
    ApprovedBy: "", 
    Time: "", 
    Show: <Link href={'/sbfa-purchase-order-form'}><SearchIcon /></Link>,
  },
  {
    PoNo: "10002",
    PODate: "2024-09-13", 
  ...
  return (
    ...
    <div className="material-account w-[106.2%] bg-[#1E1E2E] -ml-10 p-[61px] -mb-10 -mt-10 h-[100vh]">
      ...
      <div className="p-6 bg-[#27303D] shadow-md rounded-md mt-10 ">
       <h1 className="mb-4 text-xl text-white">SBFA Purchase Order</h1>
            ...
            <div className="grid grid-cols-3 w-[400px] mb-10">
              <DropdownMenu>
                ...
                <DropdownMenuContent   className="w-56 text-white bg-[#1E1E2E] border-none shadow-[0px_0px_10px_5px_rgba(0,0,0,0.5)]">
                  ...
                  <DropdownMenuCheckboxItem className="focus:bg-[#3D9C75]"  checked={PoNo} onCheckedChange={setPoNo}>PO No</DropdownMenuCheckboxItem>
        <DropdownMenuCheckboxItem className="focus:bg-[#3D9C75]"  checked={PODate} onCheckedChange={setPODate}>PO Date</DropdownMenuCheckboxItem>
