...
const OutwardGatePass = () => {
    ...
    return (
        <div className='w-[106.2%] bg-[#1E1E2E] -ml-10 p-[61px]  -mb-10 -mt-[400px]'>
        <div className="material-return-form-container p-6  bg-[#27303D] shadow-md rounded-md mt-5">
            <h1 className="text-xl font-semibold mb-8">Outward Gate Pass</h1>
      ...
      >
        ...
        <option value="pro2">pro2</option>
                    ...
                    <div className="col-span-1">
                        <label className="flex text-sm font-medium text-gray-700"><BaggageClaim className='pr-1'/>OGP QTY</label>
                        <Input
                            type="number"
                            {...register('igpQty')}
                            placeholder="54"
