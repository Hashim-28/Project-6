...
const demo = [
  {
   ...
   IGPDate: "2024-09-13",
    ...
    Show: <Link href={'/inward-gate-pass-report'}><SearchIcon /></Link>,
  },
  {
   IGPNo: "10002",
   IGPDate: "2024-09-13",
...
const ApproveIGP = () => {
  const [IGPNo, setIGPNo] = useState<Checked>(false);
  const [IGPDate, setIGPDate] = useState<Checked>(false);
  ...
  const allColumns = [
    { key: 'IGPNo', name: 'IGP No' },
    { key: 'IGPDate', name: 'IGP Date' },
  ...
  const areAnyColumnsSelected = [
   IGPNo,IGPDate, ApprovedBy, Time, Show
].some(Boolean);

const selectedColumns = areAnyColumnsSelected ? allColumns.filter((column) => {
    switch (column.key) {
      case 'IgpNo': return IGPNo;
      case 'IgpDate': return IGPDate;
...
const selectedOption = [
  ...
  //       params: {
  //       IGPNo: formData.IGPNo,
  //       IGPDate: formData.IGPDate,
  ...
  return (
    ...
    <div className="material-account w-[106.2%] bg-[#1E1E2E] -ml-10 p-[61px] -mb-10 -mt-10 h-[100vh]">
      ...
      <div className="p-6 bg-[#27303D] shadow-md rounded-md mt-10 ">
       <h1 className="mb-4 text-xl text-white">Approve IGP</h1>
            ...
            <div className="grid grid-cols-3 w-[400px] mb-10">
              <DropdownMenu>
                ...
                <DropdownMenuContent   className="w-56 text-white bg-[#1E1E2E] border-none shadow-[0px_0px_10px_5px_rgba(0,0,0,0.5)]">
                  ...
                  <DropdownMenuCheckboxItem className="focus:bg-[#3D9C75]" checked={IGPNo} onCheckedChange={setIGPNo}>IGP No</DropdownMenuCheckboxItem>
        <DropdownMenuCheckboxItem className="focus:bg-[#3D9C75]" checked={IGPDate} onCheckedChange={setIGPDate}>IGP Date</DropdownMenuCheckboxItem>
