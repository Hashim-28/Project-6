...
import { BaggageClaim, Banknote, CalendarRange, ClipboardList, Edit, FolderPen, MapPinCheckInside, MessageCircleMore, MessageSquareText, PlusCircle, ScrollText, ShoppingCart, SquareChartGantt, Star, Trash2, XCircle } from 'lucide-react';
import  '../../app/Style/purchase.css';

const MaterialReturnNote = () => {
    ...
    return (
        ...
        <div className="material-return-form-container p-6 bg-[#27303D] shadow-md rounded-md mt-5">
            <h1 className="text-xl font-semibold mb-8">Material Return Note</h1>
      ...
      >
        ...
        <option value="pro2">pro2</option>
                    ...
                    <div>
                        <label className="flex text-sm font-medium text-gray-700"><ClipboardList className='pr-1'/>Vendor</label>
                        <Input
                            type="text"
                            {...register('vendor')}
                ...
                <div className="grid grid-cols-1 sm:grid-cols-4 lg:grid-cols-8 gap-4 mb-4">
      ...
      >
        ...
        <option value="pro2">pro2</option>
                    ...
                    <div className="col-span-1">
                        <label className="flex text-sm font-medium text-gray-700"><BaggageClaim className='pr-1'/>QTY</label>
                        <Input
                            type="number"
                            {...register('qty')}
                            placeholder="31"
...
export default MaterialReturnNote;