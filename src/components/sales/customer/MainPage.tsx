...
const MainPage = () => {
const [CustID, setCustID] = useState<Checked>(false);
const [CustN, setCustN] = useState<Checked>(false);
const [CustAddr, setCustAddr] = useState<Checked>(false);
const [CreatBy, setCreatBy] = useState<Checked>(false);
...
const areAnyColumnsSelected = [
    CustID, CustN, CustAddr, CreatBy
].some(Boolean);

const selectedColumns = areAnyColumnsSelected ? allColumns.filter((column) => {
    switch (column.key) {
      case 'CustID': return CustID;
      case 'CustN': return CustN;
      case 'CustAddr': return CustAddr;
      case 'CreatBy': return CreatBy;
      default: return true;
    }
}) : allColumns;
            ...
            <div className="grid grid-cols-3 w-[400px] mb-10">
              <DropdownMenu>
                ...
                <DropdownMenuContent   className="w-56 text-white bg-[#1E1E2E] border-none shadow-[0px_0px_10px_5px_rgba(0,0,0,0.5)]">
                  ...
                  <DropdownMenuCheckboxItem className="focus:bg-[#3D9C75]" checked={CustID} onCheckedChange={setCustID}>Customer ID</DropdownMenuCheckboxItem>
<DropdownMenuCheckboxItem className="focus:bg-[#3D9C75]" checked={CustN} onCheckedChange={setCustN}>Customer Name</DropdownMenuCheckboxItem>
<DropdownMenuCheckboxItem className="focus:bg-[#3D9C75]" checked={CustAddr} onCheckedChange={setCustAddr}>Customer Address</DropdownMenuCheckboxItem>
<DropdownMenuCheckboxItem className="focus:bg-[#3D9C75]" checked={CreatBy} onCheckedChange={setCreatBy}>Created By</DropdownMenuCheckboxItem>
