  ...
  return (
    ...
    <div className="material-account w-[106.2%] bg-[#1E1E2E] -ml-10 p-[61px] -mb-10 -mt-[50px] ">
      ...
      <div className="p-6 bg-[#27303D] shadow-md rounded-md -mt-10">
        <div className="flex">
      <h1 className="text-lg text-white mb-10 ml-[40%]">Material Account Details</h1>
              <Button onClick={printer} className="ml-[30%] -mt-2"><Printer className="mr-1"/>Print</Button>
              </div>
        ...
        <div className="table-container">
          {loading ? (
           ...
           <DataGrid columns={selectedColumns} rows={displayedRows} className="react-data-grid opacity-80"  />
           </div>
          )}
        </div>
      </div>
...
export default MaterialAccountDetail;
