  ...
  return (
    <div className="material-account w-[106.2%] bg-[#1E1E2E] -ml-10 p-[61px] -mb-10 -mt-[50px] ">
     <div className=" w-1/2 bg-[#27303D] shadow-xl rounded-3xl p-2 flex item-center justify-center ml-80">
      ...
      <h1 className="text-lg text-white mb-10 ml-[3%]">Material Balance Report</h1>
              <Button onClick={printer} className="ml-[70%] -mt-2"><Printer className="mr-1"/>Print</Button>
              </div>
      <form>
      ...
      <h1 className="text-lg text-white mb-10 ml-[3%]">Material Balance Report</h1>
        ...
        <div className="table-container">
          {loading ? (
            ...
            <DataGrid columns={selectedColumns} rows={displayedRows} className="react-data-grid"/>
            </div>
          )}
        </div>
      </div>
