...
const demo = [{GPNo:"1014",PoNo:"10135",VN:"Amir Package",IC:"07-004-005",IN:"Product1",UMO:'PCs',QTY:'250',BillRate:"250",QR:'0',GRNDate:"21/feb/2024",Value:'25'},
{GPNo:"1014",PoNo:"10135",VN:"Amir Package",IC:"07-004-005",IN:"Product1",UMO:'PCs',QTY:'250',BillRate:"250",QR:'0',GRNDate:"21/feb/2024",Value:'25'},
];
const SearchBy = () => {
  ...
  return (
    <div className="main-container w-[106.2%] bg-[#1E1E2E] -ml-10 p-[61px] -mb-10 -mt-[50px] ">
      ...
      <div className="reports-container p-6 bg-[#27303D] shadow-md rounded-md -mt-10">
        ...
        <h1 className="ml-[550px] w-[200px]">Search By</h1>
