...
const MaterialClosingBalanceReport = () => {
  ...
  return (
    <div className="material-account w-[106.2%] bg-[#1E1E2E] -ml-10 p-[61px] -mb-10 -mt-[50px] ">
      ...
      <h1 className="text-lg text-white mb-10 ml-[40%]">Material Closing Balance Report</h1>
      ...
      <form>
            <div className="grid grid-cols-2 gap-4">
                <div>
              <label className="text-white">Catagory</label>
...
export default MaterialClosingBalanceReport;
