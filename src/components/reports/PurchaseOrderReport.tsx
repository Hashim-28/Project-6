...
const demo = [{ReqNo:"1014",PoNo:"10135",PoDate:"06/sep/2024",DDate:'10/jan/15',VN:"Amir Package",IC:"07-004-005",IN:"Product1",UMO:'PCs',QTY:'250',Rate:"",TQR:'0',GRNDate:"21/feb/2024",Balance:'25'},
{ReqNo:"1014",PoNo:"10135",PoDate:"06/sep/2024",DDate:'10/jan/15',VN:"Amir Package",IC:"07-004-005",IN:"Product1",UMO:'PCs',QTY:'250',Rate:"",TQR:'0',GRNDate:"21/feb/2024",Balance:'25'},
...
const PurchaseOrderReport = () => {
  ...
  const allColumns = [
    { key: 'ReqNo', name: 'Request No' },
    { key: 'PoNo', name: 'PO No' },
    { key: 'PoDate', name: 'PO Date' },
    { key: 'DDate', name: 'Delivery Date' },
  ...
  return (
    <div className="main-container w-[106.2%] bg-[#1E1E2E] -ml-10 p-[61px] -mb-10 -mt-[50px] ">
      ...
      <div className="reports-container p-6 bg-[#27303D] shadow-md rounded-md -mt-10">
        ...
        <h1 className="ml-[500px] w-[300px]">Purchase Order Report</h1>
